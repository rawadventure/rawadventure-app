...
export const PRESET_S3_J1_FRESH: TimelineSnapshot = {
  id: 's3_j1_fresh',
  label: 'S3 J1 (S1-S2 prefilled)',
  description: 'Salve contenu S3 Alimentation. Toile 2 branches peuplées.',
  phase: 'phase_1',
  currentDay: 31,
  pillarId: 'S3',
  dayInPillarWeek: 1,
...
export const PRESET_S5_J1_FRESH: TimelineSnapshot = {
  id: 's5_j1_fresh',
  label: 'S5 J1 (S1-S4 prefilled)',
  description: 'Salve contenu S5 Repos & régénération (type B, acte libre).',
  phase: 'phase_1',
  currentDay: 45,
  pillarId: 'S5',
  dayInPillarWeek: 1,
...
export const PRESET_S6_J1_FRESH: TimelineSnapshot = {
  id: 's6_j1_fresh',
  label: 'S6 J1 (S1-S5 prefilled)',
  description: 'Salve contenu S6 Passion et chemin de vie.',
  phase: 'phase_1',
  currentDay: 52,
  pillarId: 'S6',
  dayInPillarWeek: 1,
...
export const PRESET_S7_J1_FRESH: TimelineSnapshot = {
  id: 's7_j1_fresh',
  label: 'S7 J1 (S1-S6 prefilled)',
  description: 'Salve contenu S7 Mindset (type B, programme 3 phases).',
  phase: 'phase_1',
  currentDay: 59,
  pillarId: 'S7',
  dayInPillarWeek: 1,
...
export const PRESET_S8_J1_FRESH: TimelineSnapshot = {
  id: 's8_j1_fresh',
  label: 'S8 J1 (S1-S7 prefilled)',
  description: 'Salve contenu S8 Élimination & détox. Toile 7 branches.',
  phase: 'phase_1',
  currentDay: 66,
  pillarId: 'S8',
  dayInPillarWeek: 1,
