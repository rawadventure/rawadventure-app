...
|---|---|---|---|---|---|---|
| C1 S1 Respiration | OK (17 sept) | OK | OK — bas « Coûteuse » (niv. 1), haut « Régulatrice » (niv. 5), inversions Q6/7/8 OK ; fond des 5 messages [copy à valider] jugé bon (juste, non culpabilisant) | OK — J1 nez → J7 optimum lisible | Engagement 5/10/20 clair ; cercle animé : ressenti sur la durée à retravailler — chantier POST-SORTIE acté par Stéphane (pas de retouche V1) | Dernier bloc C — les 8 piliers sont passés. |
...
| C5 S5 Repos & régénération | OK (16 sept) | OK — formulations courtes jugées passables (rien de bloquant remonté) | OK — bas « Rythme très désorganisé » (niv. 1), inversions Q3/4/5/6/10 OK ; haut « Rythme soutenant » (niv. 4) : plafonne sous le niveau 5, même signal seuil qu'en C2 | OK | OK — acte libre, aucune durée affichée (confirme C3) | Type B (D41) — rien d'anormal à l'écran. |
| C6 S6 Passion | OK (16 sept) | OK — le sujet « intérieur » tient sans dévelop. perso creux (principe 6 respecté) | OK — bas « Passion déconnectée » (niv. 1), haut « Passion intégrée » (niv. 5) : avec des 5 francs le niveau 5 s'atteint → le plafonnement C2/C5 venait des réponses à 4, seuil cohérent | OK | OK — chrono 15/30/60 crédible | Signal seuil niveau 5 clos : comportement voulu probable, simple confirmation Jacky (point d du B1.1). |
| C7 S7 Mindset | OK (16 sept) — mapping vérifié (mindset, pas nature) | OK — cotation piégeuse (6 inversions) mais fonctionnelle | OK — bas « Mental subi » (niv. 1), haut « Mental orienté » (niv. 5) : les 6 inversions Q2/3/4/7/8/11 fonctionnent | OK — progression 3 phases lisible | OK — acte libre | Type B (D41). |
| C8 S8 Élimination & détox | OK (16 sept) | OK — ton sobre, pas de promesse détox marketing (principe 6 respecté) | OK — bas « Élimination ralentie » (niv. 1), haut « Élimination fluide » (niv. 5), inversions Q4/5/6 OK | OK | OK — acte libre | Toile à 7 branches : lisible. |
